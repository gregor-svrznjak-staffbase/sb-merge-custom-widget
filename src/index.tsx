...
import { MylatestpayslipProps, Mylatestpayslip } from "./mylatestpayslip";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/mylatestpayslip.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <mylatestpayslip message="world!"></mylatestpayslip>
   */
  return class MylatestpayslipBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): MylatestpayslipProps {
      const attrs = this.parseAttributes<MylatestpayslipProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<Mylatestpayslip {...this.props} />);
    }
